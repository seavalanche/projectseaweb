...
const Baldor = {
    ...
    gender: { en: "Genderless", jp: "" },
    species: { en: "Boulder creature", jp: "" },
    height: { en: "5 m", jp: "" },
    weight: { en: "60.000 kg", jp: "" },
    createdDate: { en: "26 February 2025", jp: "" },
    attributes: ["Nature"],
    bio: {
    ...
    artworks: [
        {
            ...
            caption: { en: "The original Baldor reference sheet.", jp: "" }
        },
    ]
};
