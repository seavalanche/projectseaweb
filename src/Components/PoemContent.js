...
import { getBookmark, saveBookmark } from '../Components/PoemBookmark'
...
function PoemContent({ chapterId }) {
        ...
        const loadChapter = async () => {
            try {
                const content = await import(
                    `../translations/${language}/poemchapters/${chapterId}.md`
                );
                ...
                if (language !== 'en') {
                    const enContent = await import(
                        `../translations/en/poemchapters/${chapterId}.md`
                    );
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            const contentHeight = document.getElementById('poem-content-wrapper')?.scrollHeight || 0;
    ...
    return (
        <div id="poem-content-wrapper" ref={contentRef}>
