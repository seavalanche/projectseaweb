...
function CharacterCard({ character }) {
    ...
    return (
        <div id={character.id} ref={cardRef} className={`character-card ${selectedArt ? 'preview-open' : ''} ${activeTab ? 'opened' : ''}`}>
            ...
            <div className="charcard-content">
                <div className='charcard-content-main'>
                    <div className='charcard-contentA'>
                        ...
                        <div className='charcard-contentA2'>
                            <div className={`charcardValue ${character.gender}`}>
                                {/* <div className='charcardProp'>{t("charcard.gender")}</div> */}
                                {character.gender}
                            </div>
                            <div className='charcard-contentA2-list pronouns'>
                                {/* <div className='charcardProp'>Pronouns</div> */}
                                <div className={`charcardValue pronouns ${character.pronouns?.map(p => p.toLowerCase()).join(' ') || ''}`}>
                                    {character.pronouns?.map((pronoun) => (
                                        <span key={pronoun} className={`pronoun-badge ${pronoun.toLowerCase()}`}>
                                            {pronoun}
                                        </span>
                                    ))}
                                </div>
                            </div>
                            <div className='charcard-contentA2-list'>
                                <div className='charcardProp'>{t("charcard.species")}</div>
                                {character.species}
                            </div>
                            <div className='charcard-contentA2-list WH'>
                            ...
                            <div className="charcard-contentA2-list attributes">
                    ...
                    <div className='charcard-contentB'>{character.bio}</div>
                </div>
                {activeTab === 'charcard-description' && (
                    <div className='charcard-extra'>
                        <div className='charcard-desc-list'>
                ...
                {activeTab === 'charcard-moves' && (
                    <div className="charcard-extra">
                        ...
                        <div className='charcard-desc-list even'>
